...
exclude = [status.INITIAL_IDEA, status.AWAITING_EDITOR, status.AWAITING_REVIEW, status.IDEA_IN_DEVELOPMENT_ASSIGNED, status.AWAITING_ANSWER, status.WRITING_FLEXIBLE, status.AWAITING_APPROVAL_FOR_TESTSOLVING, status.REVISING_POST_TESTSOLVING, status.AWAITING_APPROVAL_POST_TESTSOLVING, status.NEEDS_SOLUTION, status.AWAITING_SOLUTION_APPROVAL, status.NEEDS_POSTPROD, status.NEEDS_FACTCHECK, status.NEEDS_FINAL_REVISIONS, status.NEEDS_COPY_EDITS, status.AWAITING_HINTS_APPROVAL, status.DEFERRED, status.DEAD]
